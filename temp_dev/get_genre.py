...
def isole_date(soup):    # in id='Fiche_livre'
# def isole_date(self,soup):    # in id='Fiche_livre'
    ...
    # if debug: print("all_elemnt : ", all_elemnt)           # a bit long I guess
    ...
    if debug:
        print(f"return date : {vol_dp_lgl}")
        # self.log.info(self.who,f"return date : {vol_dp_lgl}")
    return vol_dp_lgl

def isole_genre(soup):    # in id='Fiche_livre'
    '''
    ...
    vol_genre=[] #lrp gaffe devient une liste voir impact
    ...
    if debug:
        print(f"return genre : {vol_genre}")
        # self.log.info(self.who,f"return genre : {vol_genre}")
    return vol_genre
...
dp_lgl = isole_date(soup_fiche_livre)
genre = isole_genre(soup_fiche_livre)
print("Genre:", genre)
