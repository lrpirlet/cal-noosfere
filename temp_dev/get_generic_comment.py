  ...
  <div>
   <p>
    ...
    <a href="https://www.noosfere.org/livres/niourf.asp?numlivre=-990755478">
     https://www.noosfere.org/livres/niourf.asp?numlivre=-990755478
    </a>
   </p>
   <div>
    <p>
     ...
     <a href="https://images.noosfere.org/couv/p/pdf001-1954.jpg">
      https://images.noosfere.org/couv/p/pdf001-1954.jpg
     </a>
    </p>
   </div>
   <div>
   ...
   <div class="sousbloc">
    ...
    <p align="right" style="line-height: normal;margin-right: 20px;">
     ...
     <font size="-1">
      Première parution : 1/10/2013Bifrost 72Mise en ligne le : 17/2/2019
     </font>
    </p>
    <hr style="color:CCC;"/>
    <p>
    ...
    <p align="right" style="line-height: normal;margin-right: 20px;">
     ...
     <font size="-1">
      Première parution : 1/9/1955Fiction 22Mise en ligne le : 6/4/2025
     </font>
    </p>
    <hr style="color:CCC;"/>
    <p>
    ...
    <div id="critique">
     <div>
      ...
      divise critiques et lecteurs, à l'intérieur et à l'extérieur du petit monde de la SF.     Pour les purs et durs, Bradbury se moque de la vraisemblance (pseudo)-scientifique et écrit de l'anti-SF. De l'autre côté des barbelés, on s'interroge sur cet apatride magnifique rédigeant de la SF comme on écrit de la littérature : ça de la SF ! Allons donc : trop bien écrit pour « en être ». En définitive, les sectaires des deux camps s'accordent sur un point : Ray Bradbury n'est pas un écrivain de SF. Ce qui — bien entendu — ne change en rien la vie de ceux qui, trop occupés à déguster, n'ont pas le temps de lire les étiquettes !     À deux années du cinquantenaire de cette œuvre fondatrice, un nouveau débat est lancé : les
      <i>
       Chroniques martiennes
      </i>
      ne seraient pas un recueil de nouvelles (comme chacun croyait le savoir) mais un roman.     Qu'en penser ? Que répondre ?     Rappeler que chaque pièce de ce recueil est une œuvre parfaitement autonome — écrite, publiée et lue en son temps comme telle ; ce qui ne contredit en rien l'évidence d'un projet global initial. Admettre que l'une s'enrichit par proximité avec les autres : bien sûr ! Que l'ensemble constitue désormais — mais pas systématiquement : des chroniques sont parfois reprises en anthologies, adaptées en BD ou en épisodes de séries TV — un tout cohérent dans son esthétique et sa thématique : autre évidence ! Penser que ce tout est supérieur à la somme de ses parts, pourquoi pas ?     Mais rien dans ce qui précède n'autorise à qualifier de « roman » les
      <i>
       Chroniques martiennes.
      </i>
      Passer outre, c'est à mon sens nier la spécificité même de la SF : une littérature dont le vecteur idéal est la « forme courte ». Constat historique mais aussi « technique » — le genre s'est développé dans des périodiques.     Certains auteurs souhaitant donner du souffle à leur œuvre (et la vendre deux fois...) ont inventé le
      <i>
       « fix-up »
      </i>
      ...
      comme étant des « romans » : c'est à mon sens confondre feuilleton et série.     Cette nouvelle édition des
      <i>
       Chroniques Martiennes,
      </i>
    ...
    <p align="right" style="line-height: normal;margin-right: 20px;">
     ...
     <font size="-1">
      Première parution : 1/3/1998dans
...
print("type soup_fiche_livre:", type(soup_fiche_livre))
